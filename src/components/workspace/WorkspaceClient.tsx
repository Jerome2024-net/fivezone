...
const CATEGORY_TOOLS: Record<string, { label: string; icon: any }> = {
  // Dev / Tech
  'Tech': { label: 'Dev Tools', icon: Monitor },
  'Développement': { label: 'Dev Tools', icon: Monitor },
  'Development': { label: 'Dev Tools', icon: Monitor },
  'Web Development': { label: 'Dev Tools', icon: Monitor },
  'Mobile Development': { label: 'Dev Tools', icon: Monitor },
  'Data Science': { label: 'Dev Tools', icon: Monitor },
  'Cybersecurity': { label: 'Dev Tools', icon: Monitor },
  'IT Support': { label: 'Dev Tools', icon: Monitor },
  // Design
  'Design': { label: 'Design Tools', icon: Pen },
  'Graphic Design': { label: 'Design Tools', icon: Pen },
  'UI/UX Design': { label: 'Design Tools', icon: Pen },
  'Animation': { label: 'Design Tools', icon: Pen },
  'Photography': { label: 'Design Tools', icon: Pen },
  'Video Editing': { label: 'Design Tools', icon: Pen },
  // Legal
  'Juridique': { label: 'Legal Tools', icon: Landmark },
  'Legal': { label: 'Legal Tools', icon: Landmark },
  'Legal Services': { label: 'Legal Tools', icon: Landmark },
  // Marketing
  'Marketing': { label: 'Marketing Tools', icon: BarChart3 },
  'Digital Marketing': { label: 'Marketing Tools', icon: BarChart3 },
  'SEO/SEA': { label: 'Marketing Tools', icon: BarChart3 },
  'Copywriting': { label: 'Marketing Tools', icon: BarChart3 },
  // Cleaning
  'Nettoyage': { label: 'Cleaning Tools', icon: Droplets },
  'Cleaning': { label: 'Cleaning Tools', icon: Droplets },
  'Cleaning Services': { label: 'Cleaning Tools', icon: Droplets },
  // Business (catch-all for business-oriented professions)
  'Business': { label: 'Business Tools', icon: Building2 },
  'Consulting': { label: 'Business Tools', icon: Building2 },
  'Business Consulting': { label: 'Business Tools', icon: Building2 },
  'Accounting': { label: 'Business Tools', icon: Building2 },
  'Real Estate': { label: 'Business Tools', icon: Building2 },
  'Event Planning': { label: 'Business Tools', icon: Building2 },
  'Customer Support': { label: 'Business Tools', icon: Building2 },
  'Travel': { label: 'Business Tools', icon: Building2 },
  // Other professions → generic Business Tools
  'Education': { label: 'Business Tools', icon: Building2 },
  'Tutoring': { label: 'Business Tools', icon: Building2 },
  'Life Coaching': { label: 'Business Tools', icon: Building2 },
  'Language Teaching': { label: 'Business Tools', icon: Building2 },
  'Health': { label: 'Business Tools', icon: Building2 },
  'Nutrition': { label: 'Business Tools', icon: Building2 },
  'Wellness': { label: 'Business Tools', icon: Building2 },
  'Beauty': { label: 'Business Tools', icon: Building2 },
  'Massage': { label: 'Business Tools', icon: Building2 },
  'Fitness Training': { label: 'Business Tools', icon: Building2 },
  'Catering': { label: 'Business Tools', icon: Building2 },
  'Pastry': { label: 'Business Tools', icon: Building2 },
  'Music': { label: 'Business Tools', icon: Building2 },
  'Fashion': { label: 'Business Tools', icon: Building2 },
  'Writing': { label: 'Business Tools', icon: Building2 },
  'Handyman': { label: 'Cleaning Tools', icon: Droplets },
  'Gardening': { label: 'Cleaning Tools', icon: Droplets },
  'Transport': { label: 'Business Tools', icon: Building2 },
  'Moving': { label: 'Business Tools', icon: Building2 },
  'Childcare': { label: 'Business Tools', icon: Building2 },
  'Pet Sitting': { label: 'Business Tools', icon: Building2 },
  'Elderly Care': { label: 'Business Tools', icon: Building2 },
  'Agriculture': { label: 'Business Tools', icon: Building2 },
};
